...
export default function StepOneProfile({ formData, atualizarDados, onContinuar }: StepOneProfileProps) {
    ...
    const CardPerfil = ({
        ...
        <button
            ...
            className={`flex flex-col items-start w-full border rounded-xl p-4 text-left shadow-sm transition hover:border-green-700 ${selecionado ? 'border-green-700 bg-green-50' : 'border-gray-300 bg-white'
                }`}
        >
            <div className="flex items-center justify-between w-full mb-2">
                ...
                {selecionado && <Check className="text-green-700" />}
            </div>
        ...
        <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
                <CardPerfil
                    ...
                    selecionado={selecionado === 'DOADOR'}
                />
                <CardPerfil
                    tipo="RECEPTOR"
                    ...
                    selecionado={selecionado === 'RECEPTOR'}
                />
            </div>
            ...
            <div className="flex justify-end">
                <button
                    ...
                    className={`bg-green-700 hover:bg-green-800 text-white font-medium px-6 py-2 rounded-md flex items-center gap-2 transition ${!selecionado ? 'opacity-50 cursor-not-allowed' : ''
                        }`}
                >
                    Continuar →
                </button>
